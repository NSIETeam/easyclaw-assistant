...
description: 高端设计机构级别的设计标准。字体、间距、阴影、卡片结构、动画。
category: frontend
...
高端设计机构级别的设计标准。字体、间距、阴影、卡片结构、动画。

## English

Teaches AI to design like a high-end agency. Fonts, spacing, shadows, card structures, animations.
