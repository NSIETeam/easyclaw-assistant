---
name: lark-approval
description: 飞书审批：查询和处理审批待办/已办/实例，搜索可发起审批定义并发起审批。
category: lark
otto_tools: ["shell"]
---
...
飞书审批：查询和处理审批待办/已办/实例，搜索可发起审批定义并发起审批。

## English

Lark Approval: query and process approval tasks/history/instances, search and initiate approval definitions.
