---
name: lark-note
description: 飞书会议纪要：已知 note_id 时查询纪要详情、类型、关联文档 token。
category: lark
otto_tools: ["shell"]
---
...
飞书会议纪要：已知 note_id 时查询纪要详情、类型、关联文档 token。

## English

Lark Meeting Notes: query note details, type, associated document tokens when note_id is known.
