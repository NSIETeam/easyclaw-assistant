---
name: lark-im
description: 飞书即时通讯：收发消息、群聊管理、文件上传下载、卡片交互、表情回复。
category: lark
otto_tools: ["shell"]
---
...
飞书即时通讯：收发消息、群聊管理、文件上传下载、卡片交互、表情回复。

## English

Lark IM: send/receive messages, group chat management, file upload/download, interactive cards, reactions.
