---
name: lark-calendar
description: 飞书日历：管理日程和会议室。查看/搜索/创建日程、管理参会人、预定会议室。
category: lark
otto_tools: ["shell"]
---
...
飞书日历：管理日程和会议室。查看/搜索/创建日程、管理参会人、预定会议室。

## English

Lark Calendar: manage events and meeting rooms. View/search/create events, manage participants, book rooms.
