...
description: PowerPoint 幻灯片创建、编辑、修复。保留布局替换文本/图片/数据。
category: office
...
PowerPoint 幻灯片创建、编辑、修复。保留布局替换文本/图片/数据。

## English

Create, edit, inspect, repair, and export PowerPoint/PPT/PPTX slide decks. Preserve layouts while replacing content.
