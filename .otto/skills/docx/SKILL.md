---
name: docx
description: Word 文档创建、编辑、读写。简历、合同、报告、论文、公函等。
category: office
...
Word 文档创建、编辑、读写。简历、合同、报告、论文、公函等。

## English

Create, edit, read, and extract .docx/.doc Word files. Supports CJK typography, templates, track changes, and comments.
