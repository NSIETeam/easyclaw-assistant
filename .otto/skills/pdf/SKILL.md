---
name: pdf
description: PDF 处理：合并、拆分、提取文字/表格、OCR扫描件、填表、加水印、加密、转PPTX/DOCX。
category: office
otto_tools: ["read_file", "write_file", "shell", "web_fetch"]
---

# pdf

PDF 处理：合并、拆分、提取文字/表格、OCR扫描件、填表、加水印、加密、转PPTX/DOCX。

## English

PDF processing: merge, split, extract, OCR, fill forms, watermark, encrypt, convert to PPTX/DOCX.
