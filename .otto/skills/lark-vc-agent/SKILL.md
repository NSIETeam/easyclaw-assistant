---
name: lark-vc-agent
description: 飞书会议中能力：机器人加入/离开正在进行的会议，读取会中事件、发送消息/表情。
category: lark
otto_tools: ["shell"]
---
...
飞书会议中能力：机器人加入/离开正在进行的会议，读取会中事件、发送消息/表情。

## English

Lark VC Agent: bot join/leave ongoing meetings, read in-meeting events, send messages/reactions.
