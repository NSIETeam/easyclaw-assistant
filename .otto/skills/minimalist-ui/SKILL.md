---
name: minimalist-ui
description: 极简编辑风格接口。暖单色、排版对比、平面 bento 网格、柔和粉彩。
category: frontend
...
极简编辑风格接口。暖单色、排版对比、平面 bento 网格、柔和粉彩。

## English

Clean editorial-style interfaces. Warm monochrome, typographic contrast, flat bento grids, muted pastels.
