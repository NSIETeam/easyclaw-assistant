...
description: GitHub 仓库管理、Issue/PR 处理、文件读写、代码搜索、分支管理。
category: engineering
otto_tools: ["shell", "web_fetch"]
---

# github-operations

GitHub 仓库管理、Issue/PR 处理、文件读写、代码搜索、分支管理。

## English

GitHub operations: repo management, Issue/PR handling, file read/write, code search, branch management.
