---
name: lark-base
description: 飞书多维表格（Base）操作：建表、字段、记录、视图、统计、公式、仪表盘。
category: lark
otto_tools: ["shell"]
---
...
飞书多维表格（Base）操作：建表、字段、记录、视图、统计、公式、仪表盘。

## English

Lark Base (bitable) operations: tables, fields, records, views, statistics, formulas, dashboards.
