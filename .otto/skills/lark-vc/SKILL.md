---
name: lark-vc
description: 飞书视频会议：搜索历史会议、查询纪要（总结/待办/章节/逐字稿）、参会人快照。
category: lark
otto_tools: ["shell"]
---
...
飞书视频会议：搜索历史会议、查询纪要（总结/待办/章节/逐字稿）、参会人快照。

## English

Lark Video Conferencing: search past meetings, query minutes (summary/tasks/chapters/transcripts), participant snapshots.
