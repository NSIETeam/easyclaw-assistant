...
description: 日程待办摘要：编排日历+任务，生成指定日期的日程与未完成任务摘要。
category: lark
otto_tools: ["shell"]
---
...
日程待办摘要：编排日历+任务，生成指定日期的日程与未完成任务摘要。

## English

Standup report: orchestrate calendar + tasks to generate daily schedule and pending task summaries.
