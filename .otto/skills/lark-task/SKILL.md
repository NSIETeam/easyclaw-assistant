---
name: lark-task
description: 飞书任务：管理任务、清单和任务智能体。创建待办、更新状态、拆分子任务。
category: lark
otto_tools: ["shell"]
---
...
飞书任务：管理任务、清单和任务智能体。创建待办、更新状态、拆分子任务。

## English

Lark Tasks: manage tasks, checklists, and task agents. Create todos, update status, split subtasks.
