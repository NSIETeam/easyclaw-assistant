...
description: 纯前端网页和 UI 原型。HTML/CSS/JS/TS、Tailwind、React/Next.js、GSAP、Framer Motion。
category: frontend
...
纯前端网页和 UI 原型。HTML/CSS/JS/TS、Tailwind、React/Next.js、GSAP、Framer Motion。

## English

Build pure frontend pages and UI prototypes. HTML/CSS/JS/TS, Tailwind, React/Next.js, GSAP, Framer Motion.
