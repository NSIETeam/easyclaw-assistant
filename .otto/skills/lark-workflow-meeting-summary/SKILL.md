...
description: 会议纪要整理工作流：汇总指定时间范围内的会议纪要并生成结构化报告。
category: lark
otto_tools: ["shell"]
---
...
会议纪要整理工作流：汇总指定时间范围内的会议纪要并生成结构化报告。

## English

Meeting summary workflow: aggregate meeting minutes within a time range and generate structured reports.
